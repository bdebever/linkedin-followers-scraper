...
const ROOT_URL =
  "https://www.linkedin.com/voyager/api/voyagerOrganizationDashFollowers?decorationId=com.linkedin.voyager.dash.deco.organization.FullFollowers-1&q=organization";
...
const main = async (organizationId, total) => {
  ...
  while (moreFollowers) {
    ...
    let {
      data: { paging },
      included,
    } = await callApi(organizationId, currentIndex);
...
const formatProfileUrl = (url) =>
  url.replace("urn:li:fsd_profile:", "https://linkedin.com/in/");
